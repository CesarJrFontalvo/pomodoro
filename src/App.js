            ...
            <main>
                ...
                <div className="timer-wrapper">
                    ...
                    <div className="session-controls">
                        <div className="controls" id="start_stop" onClick={() => handleSessionControls('play_pause')}>
                            {sessionState === 'playing'
                                ? <img className="pause-icon" src="https://res.cloudinary.com/difxvqjj3/image/upload/v1648432016/freeCodeCamp/pause_pdgalr.png" alt="pause" width="25" />
                                : <img className="play-icon" src="https://res.cloudinary.com/difxvqjj3/image/upload/v1648431941/freeCodeCamp/play_uxqbfb.png" alt="play" width="25" />
                            }
                        </div>
                        <div className="controls" id="reset" onClick={() => handleSessionControls('reset')} title="Reset">
                            <img src="https://res.cloudinary.com/difxvqjj3/image/upload/v1648432016/freeCodeCamp/reset_txrjwz.png" alt="reset" className="reset-icon" width="25" />
                        </div>
                    </div>
                    <audio
                        id="beep"
                    ...
                    >
                        ...
                        Su navegador no es compatible con audio 
                    </audio>
                </div>
            </main>
        </div>
